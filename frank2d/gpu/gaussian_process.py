...
class CorrelationMatrix():
    def __init__(self, params, u, v, u2 = None, v2 = None):
        ...
        self._u = self._u2 = u.get()
        self._v = self._v2 = v.get()
    ...
    def update_params(self, params):
        """
        Update the covariance function parameters
        through params parameter.
        Parameters:
        params: dictionary
            Parameters of the covariance function.
...
class Wendland(CorrelationMatrix):
    ...
    def matrix(self, amplitude, l):
        ...
        self.set_r()
        r = self._r
        self._H = 2*1.897367*l
        r_normalized = r / self._H
        factor = (1 - r_normalized)**self._j
        factor[r_normalized > 1] = 0

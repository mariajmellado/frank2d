...
class Plot(object):
    ...
    def to_cpu(self, array):
        """
        Convert a GPU array to a CPU array if necessary.
        Parameters
        ----------
        array : cupy.ndarray.
        ...
        -------
        array : np.ndarray
            The input array as a CPU array.
        """
    ...
    def visibility(self,
        ...
        if kind == 'input':
            ...
            vis = self.to_cpu(f2d.visibility_model)
        ...
        self._visibility2d = self.to_cpu(vis)
    ...
    def intensity(self,
        ...
        if phase_shift:
            ...
            vis_ = self.to_cpu(f2d.visibility_model)

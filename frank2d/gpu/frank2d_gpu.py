...
class Frank2D(object):
    ...
    def process_vis(self, data, hermitian = True):
        ...
        if not self._set_gridded_data:
            ...
            print("Using existing gridded data...")
    ...
    def search_MAP(self, data=None,
        ...
        if not self._set_MAP:
            ...
            self._MAP_estimator = MAPEstimator(self._Rmax, N=N_opt)
            ...
            print("Using existing MAP parameters...")

    def fit(self, 
            data = None,
            find_MAP = False, initial_guess = {'m': -2, 'logl': 4, 'p': -1},
